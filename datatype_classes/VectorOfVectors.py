...
class VectorOfVectors(object):
    ...
    def __mul__(self, other):
        if isinstance(other, VectorOfVectors) or isinstance(other, float):
            ...
            raise Exception("Type error: cannot mul %s to %s" % (type(other), type(self)))
    ...
    def restrict(self, other, cells=None, nmm_interpolation_data=None):
        if isinstance(other, VectorOfVectors):
            ...
            raise Exception("Type error: cannot restrict %s to %s" % (type(other), type(self)))
    ...
    def prolong(self, other, cells=None, nmm_interpolation_data=None):
        if isinstance(other, VectorOfVectors):
            ...
            raise Exception("Type error: cannot prolong %s to %s" % (type(other), type(self)))
    ...
    def imul_sub(self, other, indices):
        if isinstance(other, float):
            ...
            raise Exception("Type error: cannot multiply %s with %s" % (type(other), type(self)))
